...
const Hero = () => {
  return (
    <section id="inicio" className="w-screen bg-test bg-cover bg-center p-16 h-screen flex justify-center items-end relative after:absolute after:w-full after:h-full after:top-0 after:left-0 after:bg-[#00000070]">
